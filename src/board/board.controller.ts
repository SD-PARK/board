...
export class BoardController {
    ...
    @ApiResponse({ status: 200, description: '조회된 게시글 정보', type: Board })
    @ApiResponse({ status: 401, description: '권한 없음' })
    ...
    @ApiResponse({ status: 201, description: '작성된 게시글 정보', type: Board })
    ...
    @ApiResponse({ status: 200, description: '수정된 게시글 정보', type: Board })
    @ApiResponse({ status: 400, description: '카테고리 ID가 유효하지 않음' })
    @ApiResponse({ status: 401, description: '권한 없음' })
