...
export class ReplyController {
    ...
    @ApiResponse({ status: 200, description: '조회된 댓글 정보', type: ViewReply, isArray: true })
    ...
    @ApiResponse({ status: 201, description: '작성된 댓글 정보', type: Reply })
    @ApiResponse({ status: 400, description: '게시글 ID 또는 부모 댓글 ID가 유효하지 않음' })
